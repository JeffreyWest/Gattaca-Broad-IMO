...
// SBS1
// An endogenous mutational process initiated by spontaneous or enzymatic deamination of 5-methylcytosine to thymine which
// generates G:T mismatches in double stranded DNA.
// Failure to detect and remove these mismatches prior to DNA replication results in fixation of the T substitution for C.
...
//public Gattaca1(Genome genome, String PrivateGenome, double h, double s, double v, Rand RN){
